...
@WebServlet("/update_book_items2")

public class update_book_items2 extends HttpServlet {
		...
		try {
			...
			if(dao.update(dto)) {
				...
				pw.print("   <div id='div1'>"
		    			+ "    <h2>successfully BookItems are Updated</h2>"
				...
				pw.print("   <div id='div1'>"
		    			+ "    <h2> Opps....!!! BookItems are not Updated</h2>"
		    			+ "    <button id='btn2'><a href='admin.html'>home</a></button>"
		    			+ "</div>");
